const requests = {
    ...
    fetchNetflix0riginals: `/discover/tv?api_key=${process.env.REACT_APP_API_KEY}&with_networks=213`,
    ...
    fetchComedyMovies: `/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&with_gehres=35`,
